//Farhana Sultana 
//farhana.sultana79@myhunter.ciny.edu
//CSci 235
//Project 5
...
template<typename ItemType>
Node<ItemType> *LinkedList<ItemType>::swap(Node<ItemType> *ptr1, Node<ItemType> *ptr2) {
    Node<ItemType> * temp = ptr2->getNext();
    ptr2->setNext(ptr1);
    ptr1->setNext(temp);
...
LinkedList<ItemType> *LinkedList<ItemType>::bubbleSort(Comparator comparator, int *counter) {
    int swapp, i;
    Node<ItemType> *ptr1;
    Node<ItemType> *lptr = NULL;
    LinkedList<ItemType> copy = reverseCopy(this);
    ...
    do
    {
        ...
        {
            if (comparator(ptr1->getItem(),ptr1->getNext()->getItem()))
            {
